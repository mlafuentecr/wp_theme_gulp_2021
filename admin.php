...
<form class="admin-email-confirm-form" name="admin-email-confirm-form"
  action="<?php echo esc_url( site_url( 'admin.php?action=confirm_admin_email', 'login_post' ) ); ?>" method="post">
  <?php
			/**
...
<form name="lostpasswordform" id="lostpasswordform"
  action="<?php echo esc_url( network_site_url( 'admin.php?action=lostpassword', 'login_post' ) ); ?>" method="post">
  <p>
	...
	case 'rp':
		...
		if ( ! $user || is_wp_error( $user ) ) {
			...
			if ( $user && $user->get_error_code() === 'expired_key' ) {
				wp_redirect( site_url( 'admin.php?action=lostpassword&error=expiredkey' ) );
			} else {
...
<form name="resetpassform" id="resetpassform"
  action="<?php echo esc_url( network_site_url( 'admin.php?action=resetpass', 'login_post' ) ); ?>" method="post"
  autocomplete="off">
...
<form name="registerform" id="registerform"
  action="<?php echo esc_url( site_url( 'admin.php?action=register', 'login_post' ) ); ?>" method="post"
...
<?php
	...
	case 'checkemail':
		...
		/** This action is documented in admin.php */
...
<form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'admin.php', 'login_post' ) ); ?>"
  method="post">
  <p>
    <label for="user_login"><?php _e( 'Username or Email Address' ); ?></label>
