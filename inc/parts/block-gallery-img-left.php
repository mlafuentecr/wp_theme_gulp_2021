<?php
  $image_1 = get_field('gallery_left_image_1');
  $image_2 = get_field('gallery_left_image_2');
  $image_3 = get_field('gallery_left_image_3');
  $image_4 = get_field('gallery_left_image_4');
  $image_5 = get_field('gallery_left_image_5');

?>

<div class="row  gallery-img-left">
  <?php
  if( $image_1 ) {
?>
  <div class="col-md-6">
    <div class="gallery-item gallery-big" style="background-image: url('<?php echo $image_1['url']; ?>')">
  ...
  <div class="col-md-3">
    <div class="row">
      ...
      <div class="col-md-12  col-6">
        <div class="gallery-item" style="background-image: url('<?php echo $image_3['url']; ?>')">
